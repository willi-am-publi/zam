...
def test_fetch_amendements_senat(
    app, lecture_senat, article1, amendements_senat, settings
):
...
def test_fetch_amendements_an(app, lecture_an, article1, amendements_an, settings):
    from zam_repondeur.fetch import get_amendements
    from zam_repondeur.models import Amendement, DBSession
...
def test_fetch_amendements_with_errored(
    app, lecture_an, article1, amendements_an, settings
):
    from zam_repondeur.fetch import get_amendements
    from zam_repondeur.models import Amendement, DBSession
